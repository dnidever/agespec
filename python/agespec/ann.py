...
class AGEANNModel():
    ...
    # Model AGE spectra using ANN model
    ...
    def fiducialspec(self):
        """ Default AGE resolution and wavelength spectrum."""
    ...
    def __call__(self,pars=None,spobs=None,snr=None,vrel=None,normalize=False,
        ...
        fiducial : bool, optional
           Use fiducial AGE resolution and wavelength values.
